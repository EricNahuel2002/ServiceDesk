    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("3e53c9d6-7b4a-4f0e-9a1b-2c3d4e5f6a7b"), null, "Administrator", "ADMINISTRATOR" },
                    { new Guid("4f64d0e7-8c5b-4a1f-8b2c-3d4e5f6a7b8c"), null, "Technician", "TECHNICIAN" },
                    { new Guid("5a75e1f8-9d6c-4b2a-9c3d-4e5f6a7b8c9d"), null, "Client", "CLIENT" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Statuses_CompanyId_Name",
                table: "Statuses",
                columns: new[] { "CompanyId", "Name" },
                unique: true);
